    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="sub-header">Add Student</h1>
          <div class="table-responsive">
			<form class="form-horizontal col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" action="<%= request.getContextPath()%>/admin/addstudent2"  method="post">
