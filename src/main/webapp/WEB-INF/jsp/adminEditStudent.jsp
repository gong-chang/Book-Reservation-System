    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="sub-header">Edit the Student</h1>
          <div class="table-responsive">
			<form class="form-horizontal col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" action="<%= request.getContextPath()%>/admin/editstudent2?oldId=${ID}"  method="post">
			  <div class="form-group">
			    <label class="control-label col-sm-2 col-md-3" for="ID">Student Number:</label>
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-2 col-md-3" for="name">Name:</label>
			    <div class="col-sm-7 col-md-7"> 
			  ...
			  <div class="form-group"> 
			    <div class="col-sm-offset-2 col-sm-7">
			      ...
			      <a href="<%= request.getContextPath()%>/admin/studentsPage" class="btn btn-danger" role="button">Cancel</a>
			    </div>
			  </div>
			</form>
          </div>
