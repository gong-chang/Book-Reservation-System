    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="sub-header">Add one Book</h1>
          <div class="table-responsive">
			<form class="form-horizontal col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" action="<%= request.getContextPath()%>/admin/addbook2"  method="post">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-7 col-md-7"> 
			      <input type="text" class="form-control" name="Stock" placeholder="Enter Book Stock">
			    </div>
			  </div>
			  <div class="form-group">
