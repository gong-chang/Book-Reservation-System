...
<html lang="zh-CN">
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="#bookslist" role="button">Reading Today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
 ...
 <hr id = bookslist class="featurette-divider">
 	<div  class="container">
		...
		<nav aria-label="Page navigation" style="text-align:center">
		  <ul class="pagination">
		    ...
		    <c:if test="${page.start==0}"><li class = "page-item active"></c:if><c:if test="${page.start!=0}"><li></c:if><a href="<%= request.getContextPath()%>/listBooks?start=0#bookslist">1</a></li>
		    <c:if test="${page.start==page.count}"> <li class = "page-item active"> </c:if><c:if test="${page.start!=page.count}"><li></c:if><a href="<%= request.getContextPath()%>/listBooks?start=${page.count}#bookslist">2</a></li>
		    <c:if test="${page.start==2*page.count}"><li class = "page-item active"></c:if><c:if test="${page.start!=2*page.count}"><li></c:if><a href="<%= request.getContextPath()%>/listBooks?start=${2*page.count}#bookslist">3</a></li>
		    <c:if test="${page.start==3*page.count}"><li class = "page-item active"></c:if><c:if test="${page.start!=3*page.count}"><li></c:if><a href="<%= request.getContextPath()%>/listBooks?start=${3*page.count}#bookslist">4</a></li>
		    <c:if test="${page.start==4*page.count}"><li class = "page-item active"></c:if><c:if test="${page.start!=4*page.count}"><li></c:if><a href="<%= request.getContextPath()%>/listBooks?start=${4*page.count}#bookslist">5</a></li>
